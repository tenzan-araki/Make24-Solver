...
def f_multiply(a,b): return a * b;
def f_subtract_1(a,b): return a - b;
def f_subtract_2(a,b): return b - a;
def f_divide_1(a,b):
    if b != 0.0:
        return a / b;
    else:
...
def get_nonequiv_eqs_array():
    ...
    for i in range(15):
        ...
        # i == 14 : all same
        a1, a2, a3, a4 = symbols('a1 a2 a3 a4'); # symbols corresponding to cards
        if i == 1:
            a1 = a2;
        elif i == 2:
            a1 = a3;
        ...
        neq_eqs_list = []; # list of simplified equations used to avoid equivalent equations
